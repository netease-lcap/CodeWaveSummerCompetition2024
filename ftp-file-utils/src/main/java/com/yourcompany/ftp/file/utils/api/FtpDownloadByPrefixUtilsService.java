 ...
 */
@Service
public class FtpDownloadByPrefixUtilsService {
     ...
     * @return 成功返回Map，Key为文件名，Value为文件的Base64编码字符串；如果连接失败或发生异常返回null
     */
    @NaslLogic
    public Map<String, String> downloadFilesByPrefix(String ftpUrl, String filePrefix) {
        ...
        try {
            ...
            LCAP_LOGGER.error("FTP批量下载异常: " + e.getMessage(), e);
            return null;
        } finally {
