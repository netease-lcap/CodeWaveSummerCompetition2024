...
public class RedisTool {
    ...
    public List<String> getHashTopN(String hashKey, Integer limit, String keywordValue, String keywordName) {
        ...
        try {
            allList = redisTemplate.<String, Object>opsForHash().values(hashKey).stream().limit(Integer.MAX_VALUE).map(value -> value != null ? value.toString() : "").collect(Collectors.toList());
        } catch (Exception e) {
